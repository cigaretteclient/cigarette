...
public class RedGifter extends RenderModule<ToggleWidget, Boolean> {
    ...
    protected void onWorldRender(WorldRenderContext ctx, @NotNull MatrixStack matrixStack) {
        ...
        if (trashDropLocation != null && !trashDropLocation.position.isInRange(ctx.worldState().cameraRenderState.pos, 3)) {
        ...
        if (worthDropLocation != null && !worthDropLocation.position.isInRange(ctx.worldState().cameraRenderState.pos, 3)) {
