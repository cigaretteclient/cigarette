...
public class TargetHUD extends RenderModule<ToggleWidget, Boolean> {
    ...
    private final ColorDropdownWidget<ToggleWidget, Boolean> bgColor = ColorDropdownWidget.buildToggle("BG Color", "The background color of the bar.").withAlpha(true).withDefaultColor(ColorHelper.colorTransparentize(CigaretteScreen.PRIMARY_COLOR, 0.4f)).withDefaultState(true);
    ...
    protected void onEnabledTick(MinecraftClient client, @NotNull ClientWorld world,
        ...
        BarDisplay.BG_COLOR = bgColor.getToggleState() ? bgColor.getStateARGB() : ColorHelper.colorTransparentize(CigaretteScreen.PRIMARY_COLOR, 0.4f);
