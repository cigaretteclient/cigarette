...
public class ColorDropdownWidget<Widget extends ToggleWidget, StateType> extends DropdownWidget<Widget, StateType> {
    ...
    public boolean getToggleState() {
        return this.header.getRawState();
    }
    ...
    public ColorDropdownWidget<Widget, StateType> withDefaultState(boolean state) {
        this.header.withDefaultState(state);
        return this;
    }
